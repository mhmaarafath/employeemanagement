...
<head>
  <meta charset="utf-8">
    ...
    <title>Employee Attandance - Log in </title>
...
<body class="hold-transition bg-img" style="background-image: url({{asset('backend/images/gallery/full/6.jpg')}})" data-overlay="4">
				...
				<div class="row no-gutters justify-content-md-center">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile h-p100">
							<h2>Daily Attandance <br> Tracking</h2>
                            ...
                            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input required autofocus type="email" name="email" id="email" value="{{ old('email') }}" class="form-control pl-15 @error('email') is-invalid @enderror" placeholder="Email"  autocomplete="email" >
                                        @error('email')
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input required type="password" name="password" id="password" class="form-control pl-15 @error('password') is-invalid @enderror" placeholder="Password" autocomplete="current-password">
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
								  ...
								  <div class="row">
									<div class="col-6">
									  <div class="checkbox">
										<input <?=old('remember') ? 'checked' : ''?> type="checkbox" name="remember" id="basic_checkbox_1" >
